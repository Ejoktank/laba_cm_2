...
void balance_method(int n, double h, double x0, double x1, bool mode, vector<double> &A, vector<double> &B, vector<double> &C, vector<double> &phi_matrix, double &hi1, double &hi2, double &mu1, double &mu2)
{
